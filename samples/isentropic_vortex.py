...
from Nulbm.lattice import Lattice
from Nulbm.constants import cs
from Nulbm.exporter import Exporter
...
def main():
    ...
    filename = f"iv-{0}.vtk"
    lattice.sync_to_host()  # Sync before output
    ...
    for it in range(max_it):
        ...
        if np.mod(it + 1, mod_it) == 0:
            lattice.sync_to_host()  # Sync before accessing host arrays
